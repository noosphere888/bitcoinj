...
public class TransactionTest {
    ...
    // For Taproot sighash calc tests
    private byte[][] SCRIPTPUBKEYS = {
            Hex.decode("512053a1f6e454df1aa2776a2814a721372d6258050de330b3c6d10ee8f4e0dda343"),
            Hex.decode("5120147c9c57132f6e7ecddba9800bb0c4449251c92a1e60371ee77557b6620f3ea3"),
            Hex.decode("76a914751e76e8199196d454941c45d1b3a323f1433bd688ac"),
            Hex.decode("5120e4d810fd50586274face62b8a807eb9719cef49c04177cc6b76a9a4251d5450e"),
            Hex.decode("512091b64d5324723a985170e4dc5a0f84c041804f2cd12660fa5dec09fc21783605"),
            Hex.decode("00147dd65592d0ab2fe0d0257d571abf032cd9db93dc"),
            Hex.decode("512075169f4001aa68f15bbed28b218df1d0a62cbbcf1188c6665110c293c907b831"),
            Hex.decode("5120712447206d7a5238acc7ff53fbe94a3b64539ad291c7cdbc490b7577e4b17df5"),
            Hex.decode("512077e30a5522dd9f894c3f8b8bd4c4b2cf82ca7da8a3ea6a239655c39c050ab220")
    };

    private Coin[] COINS = {
            Coin.valueOf(420000000),
            Coin.valueOf(462000000),
            Coin.valueOf(294000000),
            Coin.valueOf(504000000),
            Coin.valueOf(630000000),
            Coin.valueOf(378000000),
            Coin.valueOf(672000000),
            Coin.valueOf(546000000),
            Coin.valueOf(588000000),
    };
    ...
    // Test vectors taken from here: https://github.com/sipa/bips/blob/e35a46ecf3031c21dc7f7fdb694986789a3a8144/bip-0341/wallet-test-vectors.json
    @Test
    public void testTaprootSighashCalculation() {
        Transaction tx = new Transaction(MainNetParams.get(), Hex.decode(""));
        final Sha256Hash input0SigHash = tx.hashForTaprootWitnessSignature(0, Transaction.SigHash.SINGLE, SCRIPTPUBKEYS, COINS, false);
        final Sha256Hash input3SigHash = tx.hashForTaprootWitnessSignature(3, Transaction.SigHash.ALL, SCRIPTPUBKEYS, COINS, false);
        final Sha256Hash input4SigHash = tx.hashForTaprootWitnessSignature(4, Transaction.SigHash.UNSET, SCRIPTPUBKEYS, COINS, false);
        final Sha256Hash input6SigHash = tx.hashForTaprootWitnessSignature(6, Transaction.SigHash.NONE, SCRIPTPUBKEYS, COINS, false);
        assert("2514a6272f85cfa0f45eb907fcb0d121b808ed37c6ea160a5a9046ed5526d555".equals(input0SigHash.toString()));
        assert("bf013ea93474aa67815b1b6cc441d23b64fa310911d991e713cd34c7f5d46669".equals(input3SigHash.toString()));
        assert("4f900a0bae3f1446fd48490c2958b5a023228f01661cda3496a11da502a7f7ef".equals(input4SigHash.toString()));
        assert("15f25c298eb5cdc7eb1d638dd2d45c97c4c59dcaec6679cfc16ad84f30876b85".equals(input6SigHash.toString()));
    }
}